...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Loyola | User Login 1</title>
            ...
            <form class="login-form" action="login" method="post">
             {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email address" value="{{ old('email') }}"  name="email" required autofocus/> 
